export default function Bounty() {
  return (
    <>
      ...
      <p style={{ color: "#6b5757", fontSize: "1.05rem", maxWidth: 720 }}>
        Harbor University holds sensitive academic and personal records for thirty thousand community members. We welcome coordinated disclosure from researchers.
      </p>
      <p style={{ color: "#6b5757", maxWidth: 720 }}>
      ...
      <div className="card">
        ...
        <p style={{ fontSize: "0.9rem", color: "#6b5757" }}>
