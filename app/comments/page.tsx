  ...
  return (
    <>
      ...
      <p style={{ color: "#6b5757", fontStyle: "italic", maxWidth: 680 }}>
        A moderated forum for the Harbor community to exchange ideas and debate issues of the day.
      </p>

      <div className="card">
        <h3 style={{ marginTop: 0 }}>Contribute to the Forum</h3>
        <form onSubmit={post}>
      ...
      <div className="card" style={{ padding: 0 }}>
        ...
        {list.length === 0 && <p style={{ padding: "1.5rem", color: "#6b5757", fontStyle: "italic", textAlign: "center" }}>No posts yet.</p>}
      </div>
    </>
  );
}
