  ...
  if (user) {
    return (
      <>
        ...
        <div className="card">
          <p>Your MyHarbor dashboard is ready.</p>
          <table>
            <tbody>
              <tr><th>Username</th><td>{user.username}</td></tr>
              <tr><th>Email</th><td>{user.email}</td></tr>
              <tr><th>Role</th><td>{user.role === "admin" ? "Faculty / Staff" : "Student"}</td></tr>
            </tbody>
          </table>
  ...
  return (
    <div className="locked-page">
      <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
        <div className="crest" style={{ width: 56, height: 56, fontSize: "1.3rem", margin: "0 auto 1rem" }}>HU</div>
        <h1 style={{ margin: 0 }}>Sign in to MyHarbor</h1>
        <p style={{ color: "#6b5757", fontStyle: "italic", margin: "0.5rem 0 0" }}>
          Access courses, grades, housing, and financial aid.
        </p>
      </div>
      <div className="form-wrap">
        ...
        <div style={{ marginTop: "1.5rem", paddingTop: "1.25rem", borderTop: "1px solid #e5ddc8", textAlign: "center", fontSize: "0.85rem" }}>
          <a href="#">Forgot your Harbor ID?</a>
        </div>
      </div>
    </div>
  );
