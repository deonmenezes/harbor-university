...
export default function Profile({ params }: { params: { id: string } }) {
  ...
  if (!user) return <><h1>Profile not found</h1><p style={{ color: "#6b5757" }}>We could not locate that record.</p></>;
    ...
    <>
      <div style={{ display: "flex", alignItems: "center", gap: "1.25rem", marginBottom: "2rem" }}>
        ...
        <div>
          ...
          <div style={{ color: "#6b5757", fontSize: "0.95rem", fontFamily: '"Georgia", serif', letterSpacing: "0.05em", textTransform: "uppercase" }}>
            {user.role === "admin" ? "Faculty / Staff" : "Student"}
          </div>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <table>
          <tbody>
            ...
            <tr><th>Account type</th><td>{user.role === "admin" ? "Faculty / Staff" : "Student"}</td></tr>
          </tbody>
        </table>
      </div>
